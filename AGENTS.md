...
- **2026-09-11 Mexico Central (UTC-6):** Phase 0 — remove remaining fake `views` metrics from article data and TrendingTicker (editor-selected shelf only); add root `COMPANY.md` company OS; link strategy from this file. Rollback: revert this commit and rebuild.
