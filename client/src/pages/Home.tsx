...
// Home: Main landing page with hero, featured, categories, ads
// ============================================================

import { motion } from "framer-motion";
import { ArrowRight, Sparkles, Rss, TrendingUp } from "lucide-react";
...
const categories: Category[] = ["tech", "gaming", "culture", "lifestyle"];
    ...
    <div className="min-h-screen relative" style={{ background: "oklch(0.08 0.03 270)" }}>
        ...
        <div className="relative h-[85vh] min-h-[600px] max-h-[900px]">
          ...
          <div className="relative h-full container flex flex-col justify-end pb-16">
            ...
            >
              ...
              >
                Tech, gaming, culture, and lifestyle — curated by AI, verified by humans. 
      ...
      <section className="container relative z-10 mb-16">
        <div className="flex items-center gap-3 mb-8">
          <TrendingUp className="w-5 h-5" style={{ color: "oklch(0.85 0.18 192)" }} />
          <h2
